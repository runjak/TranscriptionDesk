...
diese zu betrachten und via der Navigierungsleiste auf andere Inhalte der Webseite zugreifen.
...
sowie die Bestenlisten aller Zeit oder des Monats näher zu betrachten. Die Bestenlisten werden bzgl. \textbf{/NF171/} angezeigt und aktualisiert.
\\\rule{\linewidth}{0.4pt}
...
sowie allgemeine Kontaktinformationen.
\\\rule{\linewidth}{0.4pt}
...
werden nun alle einzelnen Bilder Elementes angezeigt. Der Benutzer kann auf jedes dieser Bilder klicken um zu der Transkribierungsansicht des Bildes zu gelangen.
\\\rule{\linewidth}{0.4pt}
\item[\textbf{/LF152/ Geschäftsprozess:}] Erstellen der Transkribierungsseite für einzelne Objekte
\item[\textbf{Akteur:}] Benutzer
...
\\\rule{\linewidth}{0.4pt}
\item[\textbf{/LF161/ Geschäftsprozess:}] Erstellen der Erklärungsseite für Transkribierungen
\item[\textbf{Akteur:}] Benutzer
\item[\textbf{Beschreibung:}] Sofern der Benutzer ,,What are transcriptions?'' ausgewählt hat,
gelangt dieser auf eine Seite welche ihm eine grobe Erläuterung gibt was Transkribierungen sind und wozu diese benötigt werden.
\\\rule{\linewidth}{0.4pt}
...
\\\rule{\linewidth}{0.4pt}
\item[\textbf{/LF163/ Geschäftsprozess:}] Erstellen der Seite mit schon transkribierten Objekten
\item[\textbf{Akteur:}] Benutzer
\item[\textbf{Beschreibung:}] Schlussendlich, wenn der Benutzer ,,Transcribed documents'' auswählt,
kann dieser verschiedene Objekte betrachten, welche schon vollständig transkribiert wurden.
\\\rule{\linewidth}{0.4pt}
\item[\textbf{/LF170/ Geschäftsprozess:}] Einbinden einer Login/Logout-Schaltfläche
\item[\textbf{Akteur:}] Benutzer
\item[\textbf{Beschreibung:}] Ist der Benutzer nicht angemeldet, so ist eine ,,Login''-Schaltfläche vorhanden welche,
wenn diese geklickt wird, ein Dialogfeld öffnet in welcher der Benutzer sich nach \textbf{/LF200/} anmelden bzw. registrieren kann.
...
Diese Seite beinhaltet allgemeine Daten über den Benutzer, unter anderem seit wann dieser dort angemeldet ist,
...
Damit diese ebenfalls, zum Teil, transkribiert werden können
\\\rule{\linewidth}{0.4pt}
...
\\\rule{\linewidth}{0.4pt}
\item[\textbf{/LF400/ Geschäftsprozess:}] Markdown Transkribierung
\item[\textbf{Akteur:}] Benutzer
...
\item[\textbf{Akteur:}] Benutzer
\item[\textbf{Beschreibung:}] Der Benutzer soll die Möglichkeit haben seine eingegebene Markdown-Transkribierung in einem Vorschaufeld zu betrachten.
\\\rule{\linewidth}{0.4pt}
...
um ein etwaiges spezielles Symbol in dem Objekt zu beschreiben.
\end{description}
...
\item[\textbf{Beschreibung:}] Damit der Benutzer ein Gefühl dafür erhält wie gut und wie viel er zu der allgemeinen Transkribierung eines Objektes beiträgt,
...
welches die Benutzer zu einem eher kompetitiveren Verhalten anspornt, durch unter anderem Bestenlisten.
\end{description}
