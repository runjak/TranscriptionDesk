...
Wir beschränkten uns zunächst darauf, den Registrierungsprozess ganz über die Github-API laufen zu lassen, zusätzliche Authentifizierungsscripte nur in den Programmquellen zu hinterlegen und in der Oberfläche auszublenden.\\
Die verschiedenen Lizenzen und Dateirechte der Scans abstrahierten wir im Wesentlichen zu den zwei Klassen ,,public'' und ,, protected'', während letztere nur eingeloggten Nutzern sichtbar sind.\\
...
Diese Ideen übernahmen wir in den Anforderungskatalog und fügten sie agil dem ersten Meilenstein hinzu.\\
%Jakob zu openSeadragon befragen
