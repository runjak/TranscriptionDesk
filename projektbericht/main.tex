...
Danach planten wir die groben Entwicklungsetappen in drei Meilensteinen nach dem Modell der agilen Softwareentwicklung wie in Punkt 3.1 beschrieben.\\
...
Wir entschieden uns für die Implementierung von Rechtecken parallel zur Seite, um Areas of Interest zu markieren und planten den in Kapitel 4 beschriebenen Datenfluss über den Omeka-Server.\\
In den nächsten Treffen analysierten wir die Aufgabenstellung genauer und ordneten das Projekt in die Kategorien der Citizen Science nach Haklay ein. (siehe Kapitel 2.3) Um das Projekt unserer Analyse entsprechend vom Crowdsourcing abzuheben, beschlossen wir ein accountbasiertes Nutzermanagement und entschieden uns dafür, die Nutzerdaten nicht selbst zu speichern,
...
Trennung dieser zwei Mechanismen in eigenständige Aufgaben. \\
...
%erster Meilenstein, Zwischenstand
