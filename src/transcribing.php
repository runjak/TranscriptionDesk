...
<html lang="en">
    <head>
        ...
        <meta name="descirption" content="Transcribing Pictures.">
        ...
        <div class="cont">
            <div class="row">
                <div class="col-sm-6 sp editor">
                    ...
                    <div class="inner">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                ...
                <div class="col-sm-6 sp">
                    <div class="pane-label"><code>Markup</code></div>
                    <div class="inner">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                        doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1>Here will be the main tool to transcribe ancient texts.</h1>
